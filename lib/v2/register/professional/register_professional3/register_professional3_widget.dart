                                                ...
                                                child: FlutterFlowRadioButton(
                                                  ...
                                                  options: [
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'a0ekxe2q' /* Register a new business profil... */,
                                                    ),
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'm9ysesh3' /* Use existing company code (Thi... */,
                                                    )
                                                  ].toList(),
                                                  onChanged: (val) =>
                                                      safeSetState(() {}),
                                                  controller: _model
                                                      ...
                                                      FormFieldController<
                                                          ...
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                    'b35dldum' /* Register a new business profil... */,
                                                  )),
                                                  optionHeight: 120.0,
                                                  optionWidth:
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'cqiddhfk' /* Enter your guest code */,
                                                      ),
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyMedium
