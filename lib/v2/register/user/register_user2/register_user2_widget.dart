                                          ...
                                          Align(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'vauixge8' /* NDIS participant number */,
                                                ),
                                                style:
                                                  ...
                                                  decoration: InputDecoration(
                                                    ...
                                                    hintText:
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                      'df977wen' /* Enter your NDIS  (XXXXXXXXX) */,
                                                    ),
...
Early Intervention */
                                                            ...
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'beyrba68' /* Chronic Medical Conditions */,
                                                            ),
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'at8pks6o' /* Hearing Loss */,
                                                            ),
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          ...
                                                          return Align(
                                                            ...
                                                            child: Text(
                                                              ...
                                                              !FFAppState()
                                                                          .verifyForm
                                                                          .same &&
                                                                      (functions.verifyCorrectPassword(_model
                                                                              .passwordTextController
                                                                              .text) ==
                                                                          true)
                                                                  ? (FFLocalizations.of(context)
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            child: Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                'ym16lhkv' /*  I accept the detailed legal n... */,
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .bodyMedium
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            child: Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                'dlwil3fe' /*  I agree to the ITalentMind ap... */,
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .bodyMedium
