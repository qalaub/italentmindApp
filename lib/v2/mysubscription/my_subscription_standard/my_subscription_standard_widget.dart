                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'vm05tydz' /* Unlock all the power of this m... */,
                          ),
                          textAlign: TextAlign.center,
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    fontFamily: 'Inter',
                                    color: const Color(0xE8ECECEC),
                                    letterSpacing: 0.0,
                                  ),
                        ),
                      ),
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'rpv0xugy' /* Benefits of Membership */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'cj648e30' /* Benefits of Membership */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                            ...
                            children: [
                              Container(
                                ...
                                child: Align(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '9a0cx31a' /* Be seen quicker as you placed ... */,
                                    ),
                                    textAlign: TextAlign.start,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'fzlzw425' /* Benefits of Membership */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                            ...
                            children: [
                              Container(
                                ...
                                child: Align(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'mrqcxjm5' /* Utilise our innovative map fea... */,
                                    ),
                                    textAlign: TextAlign.start,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
