...
class ChatThreadComponentCopyWidget extends StatefulWidget {
  const ChatThreadComponentCopyWidget({
    super.key,
    this.chatRef,
    this.profesiona,
    this.chatRefTotal,
  ...
  @override
  State<ChatThreadComponentCopyWidget> createState() =>
      _ChatThreadComponentCopyWidgetState();
}

class _ChatThreadComponentCopyWidgetState
    extends State<ChatThreadComponentCopyWidget> {
  late ChatThreadComponentCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatThreadComponentCopyModel());
                        ...
                        return Container(
                          ...
                          child: wrapWithModel(
                            ...
                            child: ChatThreadUpdateWidget(
                              key: Key(
                                'Keyt4d_${listViewChatMessagesRecord.reference.id}',
                              ),
